...
public class BoardPanel extends JLayeredPane implements MouseMotionListener, MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        this.movingPiecePanel = Arrays.stream(this.getComponents()).filter(c -> c instanceof PiecePanel && c.getBounds().contains(e.getPoint())).map(c -> (PiecePanel) c).findFirst().orElse(null);
    }
